...
import com.hedgemen.fx.util.IOUtils;
 ...
 * @author Nathan Sweet */
@JsonAutoDetect(
		fieldVisibility = JsonAutoDetect.Visibility.NONE, setterVisibility = JsonAutoDetect.Visibility.NONE,
...
public class FileHandle {
	...
	private String getFilePath() { return file.getPath(); }
	
	@JsonCreator
	public FileHandle(@JsonProperty("filepath") String filePath, @JsonProperty("filetype") FileType fileType) {
		type = fileType;
	...
	public File file () {
		if (type == FileType.External) {
			...
			//return new File(GameContext.get().files().getExternalStoragePath(), file.getPath());
		}
		return file;
	}
	...
	public ByteBuffer loadResource() {
		...
		try {
			...
			resource = memAlloc(resourceSize);
