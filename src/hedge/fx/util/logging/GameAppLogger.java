...
import hedge.fx.math.Mathf;

import java.time.LocalDateTime;
import java.time.format.DateTimeFormatter;

import static hedge.fx.util.logging.LogLevel.ANSI_RESET;
...
public class GameAppLogger implements ILogger {
	...
	private void println(LogLevel logLevel, String message) {
		if(colorOutput)
			System.out.println(logLevel.ansiColour + message + ANSI_RESET);
		else
	...
	private void print(LogLevel LogLevel, String message) {
		if(colorOutput)
			System.out.print(logLevel.ansiColour + message + ANSI_RESET);
		else
